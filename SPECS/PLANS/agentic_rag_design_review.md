...
1. **Run existing evaluation** to establish baseline:
   ```bash
   python -m evaluation.run_evaluation --mode hybrid
   ```

2. **Create conversational test cases** at `QUESTIONS/conversational/`:
   ```markdown
   # income-followup.md
   ## Turn 1
